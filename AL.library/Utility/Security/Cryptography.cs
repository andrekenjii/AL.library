using AL.library.Utility.Tools;
using System;
using System.IO;
using System.Security.Cryptography;
using System.Text;

namespace AL.library.Utility.Security
{
    public class Cryptography
    {
        private static byte[] bIV = { 0x50, 0x08, 0xF1, 0xDD, 0xDE, 0x3C, 0xF2, 0x18, 0x44, 0x74, 0x19, 0x2C, 0x53, 0x49, 0xAB, 0xBC };
        private static string crt = (typeof(Cryptography).Namespace.FormatMaxLength(32)).EncondeTo64();
