...
namespace AL.library.Utility.Validation
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentMinimum(int value, int minimum, string message)
        {
            if (value < minimum)
                throw new InvalidOperationException(message);
        }

        public static void AssertArgumentMaximum(int value, int maximum, string message)
        {
            if (value > maximum)
                throw new InvalidOperationException(message);
        }
        ...
        public static void AssertArgumentNotNullEmpty(string object1, string message)
        {
        ...
        protected void SelfAssertArgumentMinimum(int value, int minimum, string message)
        {
            AssertionConcern.AssertArgumentMinimum(value, minimum, message);
        }

        protected void SelfAssertArgumentMaximum(int value, int maximum, string message)
        {
            AssertionConcern.AssertArgumentMaximum(value, maximum, message);
        }
        ...
        protected void SelfAssertArgumentNotNullEmpty(string object1, string message)
        {
            AssertionConcern.AssertArgumentNotNullEmpty(object1, message);
        }
